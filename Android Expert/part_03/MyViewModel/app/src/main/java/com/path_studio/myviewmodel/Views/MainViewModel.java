package com.path_studio.myviewmodel.Views;
...
public class MainViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<MovieItems>> listWeathers = new MutableLiveData<>();
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    for (int i = 0; i < list.length(); i++) {
                        ...
                        MovieItems weatherItems = new MovieItems();
    ...
    public LiveData<ArrayList<MovieItems>> getWeathers() {
        return listWeathers;
    }
