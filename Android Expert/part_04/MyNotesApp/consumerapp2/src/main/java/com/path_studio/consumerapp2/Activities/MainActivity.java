...
import com.path_studio.consumerapp2.adapter.NoteAdapter;
...
public class MainActivity extends AppCompatActivity implements LoadNotesCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.path_studio.consumerapp2.Activities.MainActivity.DataObserver myObserver = new com.path_studio.consumerapp2.Activities.MainActivity.DataObserver(handler, this);
        getContentResolver().registerContentObserver(DatabaseContract.NoteColumns.CONTENT_URI, true, myObserver);

        if (savedInstanceState == null) {
            new MainActivity.LoadNoteAsync(this, this).execute();
        } else {
